...
const CalendarIcon = (p) => <LucideIcon name="CalendarDays" {...p} />;
...
// App shell
// ─────────────────────────────────────────────────────────────
const FULLSCREEN_SCREENS = ['withdraw-cash', 'simulate-cash-out', 'pension-detail', 'edit-active-benefit', 'sign-addendum', 'bike-lease', 'pension-savings-detail', 'pension-savings-choice', 'request-time-off', 'time-off-detail'];
